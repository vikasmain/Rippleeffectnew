...
import com.bindass.dell.rippleeffect.Androarchitect;
import com.bindass.dell.rippleeffect.OverView;
import com.bindass.dell.rippleeffect.R;
import com.bindass.dell.rippleeffect.adapters.Myfragmentpageradapter;
import com.bindass.dell.rippleeffect.system;
...
public class Home extends Fragment implements ViewPager.OnPageChangeListener,TabHost.OnTabChangeListener{
    ...
    private void inittabHost() {
        ...
        tabhost.setup();
        String[] tabnames={"Android Overview","Android Architecture","System Requirements"};
    ...
    private void initviewpager() {
        ...
        listfragments.add(new OverView());
        listfragments.add(new Androarchitect());
        listfragments.add(new system());

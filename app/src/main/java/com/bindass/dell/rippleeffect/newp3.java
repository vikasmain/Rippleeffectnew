 ...
 */
public class newp3 extends Activity {
    String server_url = "https://mainhujyan.000webhostapp.com/tech1.php";

    String server_url2 = "https://mainhujyan.000webhostapp.com/tech2.php";

    String server_url3 = "https://mainhujyan.000webhostapp.com/tech3.php";

    String server_url4 = "https://mainhujyan.000webhostapp.com/tech4.php";

    String server_url5 = "https://mainhujyan.000webhostapp.com/tech5.php";
    String server_url_image = "https://mainhujyan.000webhostapp.com/tech1im.png";
    String server_url_image2 = "https://mainhujyan.000webhostapp.com/tech2im.png";

    String server_url_image3 = "https://mainhujyan.000webhostapp.com/tech3im.png";

    String server_url_image4 = "https://mainhujyan.000webhostapp.com/tech4im.png";

    String server_url_image5 = "https://mainhujyan.000webhostapp.com/tech5im.png";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RequestQueue requestQueue = Volley.newRequestQueue(newp3.this);
        ...
        ImageRequest imageRequest = new ImageRequest(server_url_image, new Response.Listener<Bitmap>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(newp3.this, "networkerror", Toast.LENGTH_SHORT).show();
        ...
        ImageRequest imageRequest5 = new ImageRequest(server_url_image5, new Response.Listener<Bitmap>() {
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(newp3.this, "Netwokerror", Toast.LENGTH_SHORT).show();
                error.printStackTrace();
            }
        });
        ...
        Mysingleton.getInstance(newp3.this).addtoreque(imageRequest);
        requestQueue.add(stringRequest2);
        Mysingleton.getInstance(newp3.this).addtoreque(imageRequest2);
        requestQueue.add(stringRequest3);
        Mysingleton.getInstance(newp3.this).addtoreque(imageRequest3);
        requestQueue.add(stringRequest4);
        Mysingleton.getInstance(newp3.this).addtoreque(imageRequest4);
        requestQueue.add(stringRequest5);
        Mysingleton.getInstance(newp3.this).addtoreque(imageRequest5);
    }
